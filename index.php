...
<head>
    <title>把李天成584吃了！</title>
    <meta itemprop="name" content="把李天成584吃了！" />
            ...
            <div style="margin:0 8% 0 9%;">
                ...
                <div id="setting" style="display: none;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="title" class="form-control" placeholder="把李天成584吃了！">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="gameTime" class="form-control" maxlength=4 placeholder="默认为120秒，修改后将不会排行">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
